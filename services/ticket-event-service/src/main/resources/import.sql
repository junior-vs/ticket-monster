...
VALUES (nextval('event_category_seq'), 'Show', NOW(), NOW()),
       (nextval('event_category_seq'), 'Teatro', NOW(), NOW()),
       (nextval('event_category_seq'), 'Esporte', NOW(), NOW()),
       (nextval('event_category_seq'), 'Conferência', NOW(), NOW()),
       (nextval('event_category_seq'), 'Musica', NOW(), NOW());
...
VALUES (nextval('event_seq'), gen_random_uuid(), 'Rock in Rio', 'Festival de música', '2025-09-01T18:00:00',
        '2025-09-10T23:59:59', 'Rio de Janeiro', 1, NOW(), NOW()),
       (nextval('event_seq'), gen_random_uuid(), 'Peça Hamlet', 'Peça clássica de Shakespeare', '2025-10-05T20:00:00',
        '2025-10-05T22:00:00', 'Teatro Municipal', 2, NOW(), NOW());
...
VALUES (nextval('media_item_seq'), gen_random_uuid(), 'https://exemplo.com/rockinrio.jpg', 'image', 1, NOW(), NOW()),
