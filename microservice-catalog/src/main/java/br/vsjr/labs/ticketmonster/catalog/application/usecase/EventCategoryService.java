package br.vsjr.labs.ticketmonster.catalog.application.usecase;
...
import br.vsjr.labs.ticketmonster.catalog.application.port.out.EventCategoryCachePort;
import br.vsjr.labs.ticketmonster.catalog.application.port.out.EventCategoryRepositoryPort;
        ...
        return findExistingCategory(id)
                ...
                .chain(hasAssociatedEvents -> {
                    if (hasAssociatedEvents) {
                        return Uni.createFrom().failure(
                                new EventCategoryInUseException(id.value().toString())
                        );
                    }
    ...
    public Uni<List<EventCategory>> listAllCategories(PageRequest page) {
        ...
        return cachePort.getEventCategoriesList(page)
                ...
                .chain(cachedOpt -> {
                    ...
                    return Panache.withSession(() -> repositoryPort.findAllOrderedByDescription()
